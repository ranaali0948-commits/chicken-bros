...
export function Hero() {
  ...
  return <section id="hero" className="relative isolate min-h-[680px] overflow-hidden bg-[var(--color-hero-red)] pt-24 sm:min-h-[760px] sm:pt-28 lg:min-h-[720px] lg:pt-32">
    ...
    <img src="/images/hero/hero-wrap.png" alt="" aria-hidden="true" className="pointer-events-none absolute bottom-[100px] left-[-58px] z-10 w-[181px] rotate-0 object-contain drop-shadow-[0_16px_14px_rgba(59,42,33,.16)] sm:-bottom-5 sm:-left-40 sm:w-64 sm:rotate-12 lg:-bottom-20 lg:-left-48 lg:w-[360px]"/>
    ...
    <div className="relative z-30 mx-auto grid max-w-7xl grid-cols-1 px-5 lg:grid-cols-[.82fr_1.18fr] lg:grid-rows-[auto_1fr] lg:gap-x-4 lg:px-8">
      <div className="relative min-w-0 animate-fade-up pt-5 sm:pt-8 lg:row-start-1 lg:pt-12">
        ...
        <h1 className="hero-mobile-word pointer-events-none absolute left-[46%] top-12 z-0 -translate-x-1/2 whitespace-nowrap font-display text-[clamp(4rem,17vw,5rem)] font-black leading-none lg:hidden">{restaurant.hero.heading}</h1>
