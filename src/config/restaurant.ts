...
export const restaurant: RestaurantConfig = {
  ...
  favicon: '/images/logo/chicken-bros-wordmark.png', phone: '+33765272890', phoneDisplay: '07 65 27 28 90', email: '',
  ...
  hero: {
    ...
    image: '/images/hero/hero-burger.png', imageFallback: 'https://images.pexels.com/photos/1639557/pexels-photo-1639557.jpeg?auto=compress&cs=tinysrgb&w=1400', imageAlt: 'Burger Chicken Bros généreux avec ingrédients en mouvement',
    benefits: [
