...
export function MenuPage({ route }: MenuPageProps) {
  ...
  useEffect(() => { setActiveCategory(categoryFromUrl()); }, [route]);
  useLayoutEffect(() => {
