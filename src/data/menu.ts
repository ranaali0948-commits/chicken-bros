...
export const menu: RestaurantMenu = { categories: [
  ...
  { id: 'chicken', name: 'Chicken', image: '/images/categories/chicken.webp', fallbackImage: images.chicken, items: [
  ...
  { id: 'wraps-naans', name: 'Wraps & Naans', image: '/images/categories/wraps-naans.webp', fallbackImage: images.wraps, items: [
  ...
  { id: 'naans', name: 'Naans', image: '/images/categories/naans.webp', fallbackImage: images.wraps, items: [
    item('naans','Nature Naan','2,00 €'),
    item('naans','Cheese Naan','3,50 €'),
    item('naans','Garlic Naan','3,50 €'),
  ]},

  { id: 'biryani', name: 'Biryani', image: '/images/categories/biryani.webp', fallbackImage: images.biryani, items: [
    item('biryani','Veg Biryani','10,00 €'),
    item('biryani','Poulet Biryani','10,00 €','',true,images.biryani),
    item('biryani','Tikka Biryani','10,00 €'),
  ]},

  { id: 'crousty', name: 'Crousty', image: '/images/categories/crousty.webp', fallbackImage: images.crousty, items: [
  ...
  { id: 'kebab', name: 'Kebab', image: '/images/categories/kebab.webp', fallbackImage: images.wraps, items: [
    item('kebab','Kebab','7,50 €','Pain normal, kebab de poulet, salade, tomate, oignon, sauce mayonnaise.'),
  ]},

  { id: 'specialites', name: 'Nos spécialités', image: '/images/categories/specialites.webp', fallbackImage: images.specialites, items: [
  ...
  { id: 'plats', name: 'Plats', image: '/images/categories/plats.webp', fallbackImage: images.plats, items: [
  ...
  { id: 'salades', name: 'Salades', image: '/images/categories/salades.webp', fallbackImage: images.salades, items: [
  ...
  { id: 'menu-enfant', name: 'Menu enfant', image: '/images/categories/menu-enfant.webp', fallbackImage: images.burgers, items: [
  ...
  { id: 'accompagnements', name: 'Accompagnements', image: '/images/categories/accompagnements.webp', fallbackImage: images.crousty, items: [
  ...
  { id: 'extras', name: 'Extras', image: '/images/categories/extras.webp', fallbackImage: images.chicken, items: [
  ...
  { id: 'boissons', name: 'Boissons', image: '/images/categories/boissons.webp', fallbackImage: images.salades, items: [
